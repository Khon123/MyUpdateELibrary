...
public class BooksSuggestionProvider extends ContentProvider {
    private static final String LOG_TAG = "ExampleApp";

    public static final String AUTHORITY = "android.camant.com.elibraryandroid.adapters.books.suggestion_Provider";
